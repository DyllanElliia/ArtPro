...
# Fast Version: Reduce the number of iterations to reduce initialization time; lower the position learning rate to avoid Gaussians becoming very noisy during optimization.
def get_default_args() -> tuple:
  dataset = GroupParams()
  dataset.sh_degree = 3
  dataset.source_path = ""
  ...
  opt = GroupParams()
  opt.iterations = 10_000
  # opt.position_lr_init = 0.00016
  # opt.position_lr_final = 0.0000016
  opt.position_lr_init = 0.00001
  opt.position_lr_final = 0.0000001
  opt.position_lr_delay_mult = 0.01
  opt.position_lr_max_steps = 10_000
  opt.feature_lr = 0.0025
  opt.opacity_lr = 0.05
  # opt.scaling_lr = 0.005
  opt.scaling_lr = 0.0025
  ...
  opt.lambda_dssim = 0.2
  opt.densification_interval = 500
  opt.opacity_reset_interval = 2_000
  opt.densify_from_iter = 500
  opt.densify_until_iter = 5_000
  # opt.densify_grad_threshold = 0.0002
  opt.densify_grad_threshold = 0.0003
  opt.random_background = False
